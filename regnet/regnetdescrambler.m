...
%% descramble! 
% S = tappednet.predict(randn(64,2.5e4));
...
c.FontSize = 20;
c.Layout.Tile = 'east';
filestring = strcat(pwd(), '/may25/Weights_', num2str(L), '.png'); 
if pics
...
c.Layout.Tile = 'east'; 
if pics
    saveas(gcf, strcat(pwd(), '/may25/FFTs_', num2str(L), '.png'));
end
% clf reset; 
...
c.Layout.Tile = 'east';
if pics
    saveas(gcf, strcat(pwd(), '/may25/LeftSV_', num2str(L), '.png'));
end
% clf reset; 
...
if pics
    saveas(gcf, strcat(pwd(), '/may25/Decay_', num2str(L), '.png'));
end
% clf reset; 
...
if pics
    saveas(gcf, strcat(pwd(), '/may25/SingLeft_', num2str(L), '.png'));
end
% clf reset; 
...
if pics
    saveas(gcf, strcat(pwd(), '/may25/SingLeftFFT_', num2str(L), '.png'));
end
% clf reset; 
