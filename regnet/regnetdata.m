...
net = load(strcat(pwd(), '/matdata/Week12_SNR1_lambdaneg4_NDNDvNDB_NN_Week12_NDBPE_minMetric2.mat'));
...
ndb = load(strcat(pwd(), '/matdata/Week12_SNR1_lambdaneg4_NDNDvNDB_NN_Week12_NDBPE_minMetric2.mat'));
ndnd = load(strcat(pwd(), '/matdata/Week9_SNR1_lambdaneg1_NDNDvNDB_NN_Week9_NDND_NoDiscardPE_minMetric2.mat'));
